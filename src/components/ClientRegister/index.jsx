          ...
          <form className="register-client-form" onSubmit={handleSubmit}>
            ...
            >
              ...
              <Typography variant="h7" width="90%">
                Autorizo a comunicação referente ao meu pedido e confirmação dos
                dados para contratação do plano.
              </Typography>
            </label>
            <button
              style={{
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <img
                      src={`${import.meta.env.VITE_API_BASE}/assets/${
                        planInfos.providerLogo
                      }`}
                      alt="Provedor image"
                      style={{
                        width: "90%",
