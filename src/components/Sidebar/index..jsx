...
function Sidebar({ selectedOption, setSelectedOption, isMobileMenuOpen, setIsMobileMenuOpen }) {
    ...
    <Box>
      <Stack
        sx={{
          ...
          top: '0',
          left: isMobileMenuOpen ? '0' : { xs: '-150%', sm: '-100%' },
          zIndex: '2',
        }}
      >
        <Box
        ...
        >
          ...
          <button onClick={() => setIsMobileMenuOpen(false)} className='sidebar-mobile-close-btn'>
            <FiChevronLeft />
          </button>
        </Box>
        <Stack
