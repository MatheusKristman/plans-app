            ...
            <form className='new-cel-plan-modal-form'>
              <div className='new-cel-plan-modal-provider-box'>
                ...
                <div className='new-cel-plan-modal-provider-options'>
                  ...
                  <label htmlFor='id2' className='new-cel-plan-modal-provider-label'>
                    <div className='new-cel-plan-modal-provider-label-logo'>
                      <img
                        src='/assets/icons/claro.png'
                        alt='Claro'
                  ...
                  <label htmlFor='id3' className='new-cel-plan-modal-provider-label'>
                    <div className='new-cel-plan-modal-provider-label-logo'>
                      <img
                        src='/assets/icons/claro.png'
                        alt='Claro'
                  ...
                  <label htmlFor='id4' className='new-cel-plan-modal-provider-label'>
                    <div className='new-cel-plan-modal-provider-label-logo'>
                      <img
                        src='/assets/icons/claro.png'
                        alt='Claro'
              ...
              <div className='new-cel-plan-modal-title-box'>
                ...
                <input type='text' name='title' className='new-cel-plan-modal-title-input' />
              </div>

              <div className='new-cel-plan-modal-cost-box'>
                <span className='new-cel-plan-modal-cost-title'>Valor</span>
                <input type='text' name='cost' className='new-cel-plan-modal-cost-input' />
              </div>

              <div className='new-cel-plan-modal-franchise-box'>
                <span className='new-cel-plan-modal-franchise-title'>Franquia de cel</span>
                <input
                  type='text'
                  name='franchise'
              ...
              <div className='new-cel-plan-modal-priority-box'>
                ...
                <select name='priority' className='new-cel-plan-modal-priority-select'>
              ...
              <div className='new-cel-plan-modal-description-box'>
                ...
                <textarea name='description' className='new-cel-plan-modal-description-textarea' />
              </div>
