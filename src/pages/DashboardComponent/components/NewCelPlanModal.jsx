...
const NewCelPlanModal = () => {
  ...
  const { deactivateModalAnimation, modalAnimation, resetBenefits, benefits } = useGeneralStore(
    (state) => ({
  ...
  useEffect(() => {
    console.log('celFranchise: ', celFranchise);
    console.log('celCost: ', celCost);
    console.log(errors);
  }, [celFranchise, celCost]);
      ...
      <div className='new-cel-plan-modal-container'>
        <div className='new-cel-plan-modal-wrapper'>
          ...
          <div className='new-cel-plan-modal-body'>
            <form onSubmit={handleSubmit(onSubmit)} className='new-cel-plan-modal-form'>
              <div className='new-cel-plan-modal-provider-box'>
                <span className='new-cel-plan-modal-provider-title'>Operadora</span>
                <div className='new-cel-plan-modal-provider-options'>
                  {allProviders?.map((provider) => (
                    <label
                      key={provider._id}
                      htmlFor={provider._id}
                      style={celProviderId === provider._id ? { pointerEvents: 'none' } : {}}
                      className={
                ...
                {celProviderError && (
                  <span style={{ marginTop: '3px' }} className='new-cel-plan-modal-error-form'>
              ...
              <div className='new-cel-plan-modal-title-box'>
                ...
                />
                {errors.title && (
                  <span className='new-internet-plan-modal-error-form'>{errors.title.message}</span>
                )}
              </div>
              ...
              <div className='new-cel-plan-modal-cost-box'>
                ...
                />
                {errors.cost && (
                  <span className='new-internet-plan-modal-error-form'>{errors.cost.message}</span>
                )}
              </div>

              <div className='new-cel-plan-modal-franchise-box'>
                <span className='new-cel-plan-modal-franchise-title'>Franquia de celular</span>
                <input
                  {...register('franchise')}
                  type='number'
                  name='franchise'
                ...
                <div className='new-cel-plan-modal-franchise-unit-wrapper'>
                  <label htmlFor='franchiseMB' className='new-cel-plan-modal-franchise-unit-label'>
                    <input
                      type='radio'
                      id='franchiseMB'
                      name='franchise'
                  ...
                  <label htmlFor='franchiseGB' className='new-cel-plan-modal-franchise-unit-label'>
                    <input
                      type='radio'
                      id='franchiseGB'
                      name='franchise'
              ...
              <div className='new-cel-plan-modal-unlimited-apps-box'>
                <span className='new-cel-plan-modal-unlimited-apps-title'>Apps ilimitados</span>
              ...
              <div className='new-cel-plan-modal-unlimited-call-box'>
                <span className='new-cel-plan-modal-unlimited-call-title'>Ligação ilimitada</span>

                <div className='new-cel-plan-modal-unlimited-call-options'>
                  <label htmlFor='yes' className='new-cel-plan-modal-unlimited-call-label'>
                    <input
                      type='radio'
                      id='yes'
                  ...
                  <label htmlFor='no' className='new-cel-plan-modal-unlimited-call-label'>
                    <input
                      type='radio'
                      id='no'
                      onChange={setCelUnlimitedCall}
              ...
              <div className='new-cel-plan-modal-plan-type-box'>
                <span className='new-cel-plan-modal-plan-type-title'>Tipo do plano</span>
                <select onChange={setCelPlanType} className='new-cel-plan-modal-plan-type-select'>
              ...
              <div className='new-cel-plan-modal-priority-box'>
                <span className='new-cel-plan-modal-priority-title'>Prioridade</span>
                <select
                  name='priority'
                  onChange={setCelPriority}
                  className='new-cel-plan-modal-priority-select'
                >
                  <option className='new-cel-plan-modal-priority-option' value={1}>
                    1
                  </option>
                  <option className='new-cel-plan-modal-priority-option' value={2}>
                    2
                  </option>
                  <option className='new-cel-plan-modal-priority-option' value={3}>
                    3
                  </option>
                  <option className='new-cel-plan-modal-priority-option' value={4}>
                    4
                  </option>
                  <option className='new-cel-plan-modal-priority-option' value={5}>
                    5
                  </option>
                  <option className='new-cel-plan-modal-priority-option' value={6}>
                    6
                  </option>
                  <option className='new-cel-plan-modal-priority-option' value={7}>
                    7
                  </option>
                  <option className='new-cel-plan-modal-priority-option' value={8}>
                    8
                  </option>
                  <option className='new-cel-plan-modal-priority-option' value={9}>
                    9
                  </option>
                  <option className='new-cel-plan-modal-priority-option' value={10}>
                    10
                  </option>
                </select>
              </div>
              ...
              <div className='new-cel-plan-modal-description-box'>
                <span className='new-cel-plan-modal-description-title'>Descrição</span>
              ...
              <button type='submit' className='new-cel-plan-modal-submit-button'>
                Salvar
              </button>
            </form>
          </div>
