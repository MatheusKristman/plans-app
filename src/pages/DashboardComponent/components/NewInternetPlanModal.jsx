...
const NewInternetPlanModal = () => {
  ...
  const { deactivateModalAnimation, modalAnimation, benefits, resetBenefits } = useGeneralStore(
    (state) => ({
      ...
      <div className='new-internet-plan-modal-container'>
        <div className='new-internet-plan-modal-wrapper'>
          ...
          <div className='new-internet-plan-modal-body'>
            <form onSubmit={handleSubmit(onSubmit)} className='new-internet-plan-modal-form'>
              <div className='new-internet-plan-modal-provider-box'>
                ...
                <div className='new-internet-plan-modal-provider-options'>
                  {allProviders?.map((provider) => (
                    <label
                      ...
                      style={internetProviderId === provider._id ? { pointerEvents: 'none' } : {}}
                      className={
                ...
                {internetProviderError && (
                  <span style={{ marginTop: '3px' }} className='new-internet-plan-modal-error-form'>
              ...
              <div className='new-internet-plan-modal-franchise-limit-box'>
                ...
                <input
                  ...
                  autoCorrect='off'
                  autoComplete='off'
                  style={errors.franchiseLimit ? { border: '2px solid #ef5959' } : {}}
