      ...
      <div className='dashboard-plan-wrapper'>
        <div className='dashboard-plan-image-title-wrapper'>
          <div className='dashboard-plan-image-box'>
            <img
              src={`https://planos-backend.onrender.com/assets/${providerIconPath}`}
              alt='Operadora'
        ...
        <div className='dashboard-plan-details-wrapper'>
          ...
          <div className='dashboard-plan-created-box'>
            ...
            <span className='dashboard-plan-created-placeholder'>Criado em</span>
          </div>

          {archivedValue ? (
            <div className='dashboard-plan-archived-date-box'>
              <span className='dashboard-plan-archived-date-value'>{archivedValue}</span>
              <span className='dashboard-plan-archived-date-placeholder'>Arquivado em</span>
            </div>
          ) : null}
        </div>
      </div>
