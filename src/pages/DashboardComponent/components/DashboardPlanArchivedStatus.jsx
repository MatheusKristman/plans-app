...
const DashboardPlanArchivedStatus = () => {
  const {
  ...
  return (
    <div className='dashboard-component-status-box'>
      <span className='dashboard-component-status'>Planos arquivados: {archivedPlans.length}</span>

      <button
        type='text'
        onClick={handleArchivedPlansVisibility}
        className='dashboard-component-show-archived-btn'
      >
        {isArchivedPlansVisible ? (
          <>
            <svg
...
export default DashboardPlanArchivedStatus;
