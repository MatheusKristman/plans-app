...
const NewTVPlanModal = () => {
  ...
  const { deactivateModalAnimation, modalAnimation } = useGeneralStore((state) => ({
          ...
          <div className='new-tv-plan-modal-body'>
            <form className='new-tv-plan-modal-form'>
              <div className='new-tv-plan-modal-provider-box'>
                <span className='new-tv-plan-modal-provider-title'>Operadora</span>
                <div className='new-tv-plan-modal-provider-options'>
                  ...
                  <label htmlFor='id2' className='new-tv-plan-modal-provider-label'>
                    <div className='new-tv-plan-modal-provider-label-logo'>
                      <img
                        src='/assets/icons/claro.png'
                        alt='Claro'
                  ...
                  <label htmlFor='id3' className='new-tv-plan-modal-provider-label'>
                    <div className='new-tv-plan-modal-provider-label-logo'>
                      <img
                        src='/assets/icons/claro.png'
                        alt='Claro'
                  ...
                  <label htmlFor='id4' className='new-tv-plan-modal-provider-label'>
                    <div className='new-tv-plan-modal-provider-label-logo'>
                      <img
                        src='/assets/icons/claro.png'
                        alt='Claro'
              ...
              <div className='new-tv-plan-modal-title-box'>
                ...
                <input type='text' name='title' className='new-tv-plan-modal-title-input' />
              </div>

              <div className='new-tv-plan-modal-cost-box'>
                <span className='new-tv-plan-modal-cost-title'>Valor</span>
                <input type='text' name='cost' className='new-tv-plan-modal-cost-input' />
              </div>
              ...
              <div className='new-tv-plan-modal-cost-changes-after-period-box'>
                ...
                <div className='new-tv-plan-modal-cost-changes-after-period-options'>
                  ...
                  <label htmlFor='no' className='new-tv-plan-modal-cost-changes-after-period-label'>
                    <input
                      type='radio'
                      id='no'
                      name='costChangesAfterPeriod'
              ...
              <div className='new-tv-plan-modal-after-cost-box'>
                <span className='new-tv-plan-modal-after-cost-title'>Valor depois do período</span>
                <input
                  type='text'
                  name='afterCost'
              ...
              <div className='new-tv-plan-modal-period-to-change-cost-box'>
                ...
                <div className='new-tv-plan-modal-period-to-change-cost-wrapper'>
                  ...
                  />
                  <span className='new-tv-plan-modal-period-to-change-cost-tag'>°</span>
                </div>
              </div>
              ...
              <div className='new-tv-plan-modal-devices-box'>
                <span className='new-tv-plan-modal-devices-title'>Pontos de TV</span>
                <select name='devices' className='new-tv-plan-modal-devices-select'>
              ...
              <div className='new-tv-plan-modal-benefits-box'>
                <span className='new-tv-plan-modal-benefits-title'>Benefícios</span>
              ...
              <div className='new-tv-plan-modal-priority-box'>
                <span className='new-tv-plan-modal-priority-title'>Prioridade</span>
                <select name='priority' className='new-tv-plan-modal-priority-select'>
                  <option className='new-tv-plan-modal-priority-option' value='1'>
                    1
                  </option>
                  <option className='new-tv-plan-modal-priority-option' value='2'>
                    2
                  </option>
                  <option className='new-tv-plan-modal-priority-option' value='3'>
                    3
                  </option>
                  <option className='new-tv-plan-modal-priority-option' value='4'>
                    4
                  </option>
                  <option className='new-tv-plan-modal-priority-option' value='5'>
                    5
                  </option>
                  <option className='new-tv-plan-modal-priority-option' value='6'>
                    6
                  </option>
                  <option className='new-tv-plan-modal-priority-option' value='7'>
                    7
                  </option>
                  <option className='new-tv-plan-modal-priority-option' value='8'>
                    8
                  </option>
                  <option className='new-tv-plan-modal-priority-option' value='9'>
                    9
                  </option>
                  <option className='new-tv-plan-modal-priority-option' value='10'>
                    10
                  </option>
                </select>
              </div>
              ...
              <div className='new-tv-plan-modal-description-box'>
                <span className='new-tv-plan-modal-description-title'>Descrição</span>
                <textarea name='description' className='new-tv-plan-modal-description-textarea' />
              </div>
