    ...
    <div id='benefits' className='benefits-container'>
      <div className='benefits-wrapper wrapper'>
        <BenefitCard
          ...
          variant={
            window.innerWidth < 1024 ? mobileBenefitAnimation : desktopFirstHalfBenefitAnimation
          }
        />
        <BenefitCard
          ...
          variant={
            window.innerWidth < 1024 ? mobileBenefitAnimation : desktopSecondHalfBenefitAnimation
          }
        />
        <BenefitCard
