...
const InternetDetailsBox = () => {
  ...
  const { closeInternetDetailsBox } = usePlansStore((state) => ({
            ...
            <div className='internet-details-box-info-wrapper'>
              <div className='internet-details-box-info'>
                <div className='internet-details-box-title-box'>
                  ...
                  <span className='internet-details-box-title-desc'>Claro Banda Larga 250MB</span>
                </div>

                <div className='internet-details-box-created-at-box'>
                  <span className='internet-details-box-created-at-label'>Criado em</span>
                  <span className='internet-details-box-created-at-desc'>24/03/2023</span>
                </div>
              </div>
              ...
              <div className='internet-details-box-info'>
                <div className='internet-details-box-cost-box'>
                  ...
                  <span className='internet-details-box-cost-desc'>R$ 49,90</span>
                </div>

                <div className='internet-details-box-total-box'>
                  <span className='internet-details-box-total-label'>Total</span>
                  <span className='internet-details-box-total-desc'>R$ 49,90</span>
                </div>
              </div>
              ...
              <div className='internet-details-box-info'>
                ...
                <div className='internet-details-box-franchise-limit-box'>
                  ...
                  <span className='internet-details-box-franchise-limit-desc'>Ilimitado</span>
                </div>
              </div>
              ...
              <div className='internet-details-box-info'>
                <div className='internet-details-box-has-wifi-box'>
                  ...
                  <span className='internet-details-box-has-wifi-desc'>Sim</span>
                </div>
                ...
                <div className='internet-details-box-technology-box'>
                  ...
                  <span className='internet-details-box-technology-desc'>Fibra ótica</span>
                </div>
              </div>

              <div className='internet-details-box-description-box'>
                <span className='internet-details-box-description-label'>Descrição</span>
                <span className='internet-details-box-description-desc'>Descrição teste</span>
              </div>

              <div className='internet-details-box-buttons-wrapper'>
                <button type='button' className='internet-details-box-edit-button'>
                  Editar
                </button>
