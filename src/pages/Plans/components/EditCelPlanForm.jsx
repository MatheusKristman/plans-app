...
const EditCelPlanForm = () => {
  const { closeEditCelForm } = usePlansStore((state) => ({
          ...
          <div className='edit-cel-plan-body'>
            <form className='edit-cel-plan-form'>
              <div className='edit-cel-plan-title-box'>
                ...
                <input type='text' name='title' className='edit-cel-plan-title-input' />
              </div>

              <div className='edit-cel-plan-cost-box'>
                <span className='edit-cel-plan-cost-title'>Valor</span>
                <input type='text' name='cost' className='edit-cel-plan-cost-input' />
              </div>

              <div className='edit-cel-plan-franchise-box'>
                <span className='edit-cel-plan-franchise-title'>Franquia de cel</span>
                <input type='text' name='franchise' className='edit-cel-plan-franchise-input' />
              ...
              <div className='edit-cel-plan-priority-box'>
                ...
                <select name='priority' className='edit-cel-plan-priority-select'>
              ...
              <div className='edit-cel-plan-description-box'>
                ...
                <textarea name='description' className='edit-cel-plan-description-textarea' />
              </div>
