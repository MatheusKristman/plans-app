            ...
            <div className="lead-details-box-info-wrapper">
              <div className="lead-details-box-info">
                ...
                <div className="lead-details-box-plan-box">
                  ...
                  <span className="lead-details-box-plan-desc">
                    {plans.filter(
                      (plan) => plan._id === clientSelectedForDetails.plan,
                    )[0]?.title || "Plano não disponível"}
                  </span>
                </div>
              </div>
              ...
              <div className="lead-details-box-info">
                <div className="lead-details-box-rg-box">
                  ...
                  <span className="lead-details-box-rg-desc">
                    {clientSelectedForDetails.rg}
                  </span>
                </div>

                <div className="lead-details-box-cpf-box">
                  <span className="lead-details-box-cpf-label">CPF</span>
                  <span className="lead-details-box-cpf-desc">
                    {clientSelectedForDetails.cpf}
                  </span>
                </div>
              </div>
              ...
              <div className="lead-details-box-info">
                <div className="lead-details-box-date-of-birth-box">
                  <span className="lead-details-box-date-of-birth-label">
                    Data de nascimento
                  </span>
                ...
                <div className="lead-details-box-mother-name-box">
                  <span className="lead-details-box-mother-name-label">
                    Nome da mãe
                  </span>
              ...
              <div className="lead-details-box-info">
                <div className="lead-details-box-tel-box">
                  ...
                  <span className="lead-details-box-tel-desc">
                    {clientSelectedForDetails.tel1}
                  </span>
                </div>
              ...
              <div className="lead-details-box-info">
                <div className="lead-details-box-cep-box">
                  ...
                  <span className="lead-details-box-cep-desc">
                    {clientSelectedForDetails.cep}
                  </span>
                </div>

                <div className="lead-details-box-address-box">
                  <span className="lead-details-box-address-label">
                    Endereço
                  </span>
              ...
              <div className="lead-details-box-info">
                <div className="lead-details-box-address-number-box">
                  <span className="lead-details-box-address-number-label">
                    Numero
                  </span>
                ...
                <div className="lead-details-box-complement-box">
                  <span className="lead-details-box-complement-label">
                    Complemento
                  </span>
              ...
              <div className="lead-details-box-info">
                <div className="lead-details-box-payment-date-box">
                  <span className="lead-details-box-payment-date-label">
                    Data do pagamento
                  </span>
                ...
                <div className="lead-details-box-payment-method-box">
                  <span className="lead-details-box-payment-method-label">
                    Método de pagamento
                  </span>
              ...
              <div className="lead-details-box-info">
                <div className="lead-details-box-bank-account-box">
                  <span className="lead-details-box-bank-account-label">
                    Conta do banco
                  </span>
                ...
                <div className="lead-details-box-account-owner-box">
                  <span className="lead-details-box-account-owner-label">
                    Dono da conta
                  </span>
