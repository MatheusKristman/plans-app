        ...
        <div className='plan-benefits-wrapper'>
          <div className='plan-benefits-box'>
            <div className='plan-benefits-installation-cost-box'>
              <span className='plan-benefits-installation-cost-title'>Custo de instalação</span>
              <span className='plan-benefits-installation-cost-value'>{installationCost}</span>
            </div>
