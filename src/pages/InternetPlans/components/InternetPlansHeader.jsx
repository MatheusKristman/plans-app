    ...
    <header className="header-container">
        ...
        <div className="header-top-wrapper wrapper">
          ...
          <nav className="header-mobile-nav">
            ...
            {isMobileMenuOpen && (
              ...
              >
                <li className="header-menu-item">Banda Larga</li>
                <li className="header-menu-item">Celular</li>
                <li className="header-menu-item">TV</li>
              </ul>
            )}
          </nav>
      ...
      <div className="header-bottom-box">
        <div className="header-bottom-wrapper wrapper">
          <h3 className="header-bottom-title">
            Planos de Internet Banda Larga
          </h3>
          <p className="header-bottom-desc">
...
export default InternetPlansHeader;
