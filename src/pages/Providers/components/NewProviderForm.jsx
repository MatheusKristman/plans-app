          ...
          <div className='new-provider-form-body'>
            <form className='new-provider-form-form'>
              <div className='new-provider-form-logo-box'>
                ...
                <label htmlFor='providerLogo' className='new-provider-form-logo-label'>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    fill='none'
                    viewBox='0 0 24 24'
              ...
              <div className='new-provider-form-provider-name-box'>
                <span className='new-provider-form-provider-name-label'>Nome da operadora</span>
              ...
              <div className='new-provider-form-cep-box'>
                <span className='new-provider-form-cep-title'>Ceps de cobertura</span>
