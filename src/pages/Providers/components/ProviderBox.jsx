...
const ProviderBox = ({ providerLogo, providerName, plansQuant, id }) => {
  const { openDetailsBox, openEditProviderForm } = useProviderStore((state) => ({
      ...
      <div className='providers-component-provider-box'>
        <div className='providers-component-info-box'>
          <div className='providers-component-image-title-box'>
            ...
            <h2 className='providers-component-provider-name'>{providerName}</h2>
          </div>

          <div className='providers-component-registered-box'>
            <span className='providers-component-registered-value'>{plansQuant}</span>
            <span className='providers-component-registered-desc'>Planos cadastrados</span>
          </div>
        </div>

        <div className='providers-component-buttons-box'>
          <button onClick={handleDetailsBoxOpen} className='providers-component-details-button'>
            Ver Detalhes
          </button>

          <button onClick={handleEditFormOpen} className='providers-component-edit-button'>
            Editar
          </button>
        </div>
      </div>
