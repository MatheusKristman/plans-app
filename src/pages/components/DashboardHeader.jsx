...
const DashboardHeader = ({ pageName, searchPlaceholder }) => {
  const { openMenu, closeMenu } = useDashboardPageStore(
    (state) => ({
  ...
  return (
    <div className='dashboard-component-header'>
      <button onClick={openMenu} type='button' className='dashboard-component-menu-btn'>
        <svg
      ...
      <label htmlFor='search' className='search-box'>
        ...
        <input type='text' name='search' placeholder={searchPlaceholder} className='search-input' />
      </label>
